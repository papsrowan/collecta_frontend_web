...
export default function AjouterCommercantPage() {
  ...
  const loadAgents = async () => {
    try {
      ...
      setError(err.response?.data?.message || 'Erreur lors du chargement des agents');
    }
  };
      ...
      <div className="page-with-sidebar">
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Nouveau Commerçant</h1>
            <p className="mt-2 text-sm text-gray-500">
              Remplissez le formulaire ci-dessous pour créer un nouveau commerçant.
            </p>
          </div>
          ...
          {success && (
            <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-3 mb-4 flex items-center">
              ...
              <p className="text-sm text-green-700 font-medium">Commerçant créé avec succès ! Redirection en cours...</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Détails du point de vente</p>
                </div>
              </div>
              <div className="space-y-5">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Agent attitré <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    ...
                    <select
                      required
                      className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all appearance-none"
                  ...
                  {agents.length === 0 && (
                    <p className="mt-1 text-xs text-orange-500">Chargement des agents...</p>
                  )}
                </div>
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              >
                ...
                {loading ? 'Enregistrement...' : 'Enregistrer le Commerçant'}
              </button>
            </div>
          </form>
        </div>
