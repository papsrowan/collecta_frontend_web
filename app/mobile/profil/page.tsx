    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 pb-20">
      ...
      <div className="px-4 -mt-6">
        ...
        <button
          ...
          className="w-full bg-red-50 border-2 border-red-200 rounded-xl p-4 flex items-center justify-center text-red-700 font-semibold mb-4"
        >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
        <div className="grid grid-cols-4 gap-1 px-2 py-2">
          ...
          <Link href="/mobile/profil" className="flex flex-col items-center justify-center py-2 text-green-600">
            <svg className="w-6 h-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
